...
class ContactController extends Controller
{
    public function contactAction(Request $request)
    {
        ...
        $form = $this->createForm('MainBundle\Form\ContactType',null,array(
            // To set the action use $this->generateUrl('route_identifier')
            'action' => $this->generateUrl('ManBundle_contact'),
            'method' => 'POST'
        ));
    ...
    private function sendEmail($data){
        $myappContactMail = 'sabrine.njoumi12@gmail.com';
        $myappContactPassword = 'sabrine96013201';
